    ...
    return (
      ...
      <Modal show={signup} onHide={handleClose}>
          <div onClick={handleClose} className="ml-auto mx-3 btn">x</div>
            <div className="h5 mx-auto oswald">SIGN UP</div>
            <Container>
      ...
      <Link to="/register"  onClick={()=>setSignup(false)}>
     <button className="btn btn-primary w-100 mt-4">SIGN UP</button>
      </Link>
            <div className="small text-center mt-3 pt-3">Sign up using your social media account</div>
           <div>
           ...
           <div className="small text-center mt-3">Already have an account? 
           <a href="#sign-in" onClick={(e)=>signinBtn(e)} className="border-bottom border"> SIGN-IN</a></div>
            </Container>
        </Modal.Body>
      </Modal>
      </>
